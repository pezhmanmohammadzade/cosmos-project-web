      ...
      <div className={cn("relative z-10 w-full grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center", 
            ...
            {app.downloadUrl ? (
              <div className="flex flex-wrap items-center gap-6">
                <a 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group/btn transition-transform duration-500 hover:scale-105 active:scale-95 shadow-[0_15px_45px_rgba(0,0,0,0.5)] rounded-[1.25rem] overflow-hidden"
                >
        ...
        <div className={cn("relative w-full aspect-[4/5] lg:aspect-square flex justify-center items-center perspective-[3000px]", !isEven && "lg:col-start-1")}>
          ...
          >
            ...
            <div className="relative w-[90%] h-[90%] flex justify-center items-center" style={{ transformStyle: 'preserve-3d' }}>
              <div className="visual-layer w-full h-full flex justify-center items-center" style={{ transformStyle: 'preserve-3d', transform: 'translateZ(-40px)' }}>
                <img 
                  src={app.appIcon || app.visual} 
                  alt={app.name}

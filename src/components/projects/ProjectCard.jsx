            ...
            {project.downloadUrl ? (
              <div className="flex flex-wrap items-center gap-6">
                <a 
                  ...
                  className="flex items-center gap-4 px-8 py-4 h-[4.5rem] rounded-[1.25rem] bg-white/10 border border-white/20 backdrop-blur-xl group/btn transition-all duration-500 hover:bg-white/20 hover:scale-105 active:scale-95 shadow-[0_15px_45px_rgba(0,0,0,0.3)]"
                >
